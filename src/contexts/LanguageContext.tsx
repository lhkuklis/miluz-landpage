...
const translations = {
  'pt-BR': {
    ...
    // Hero Section
    'hero.title': 'Seu parceiro estratégico em Recrutamento e Seleção',
    'hero.subtitle': 'Conectamos empresas a profissionais de diferentes áreas com foco em qualidade, agilidade e alinhamento cultural.',
    'hero.cta': 'Fale conosco',
    'hero.learn_more': 'Saiba mais',
    'hero.badge': 'Soluções de contratação modernas',

    // About Section
    'about.title': 'Quem Somos',
    'about.description': 'A Miluz é uma consultoria especializada em recrutamento e seleção para diversas áreas do mercado. Com expertise e inteligência de dados, conectamos empresas a profissionais qualificados com foco em resultado.',
    'about.mission': 'Nossa missão é transformar o processo de contratação com soluções personalizadas, garantindo conexões de alto impacto entre empresas e talentos.',
    'about.experience': 'Anos de experiência',
    'about.placements': 'Contratações realizadas',
    'about.clients': 'Clientes satisfeitos',

    // About Features
    'about.feature.matching.title': 'Matching assertivo',
    'about.feature.matching.desc': 'Foco na compatibilidade técnica e cultural entre empresa e candidato.',
    'about.feature.network.title': 'Rede qualificada',
    'about.feature.network.desc': 'Base sólida de profissionais com experiência e engajamento.',
    'about.feature.excellence.title': 'Excelência operacional',
    'about.feature.excellence.desc': 'Processos otimizados para resultados consistentes e ágeis.',
    ...
    'testimonials.1.text': 'A Miluz transformou nosso processo de contratação. Em poucas semanas, trouxeram um profissional alinhado ao nosso time.',
    ...
    // Specialties Section
    'home.specialties.title': 'Nossas Especialidades',
    'home.specialties.desc': 'Recrutamos talentos para as principais áreas do mercado com foco em resultado.',
    'home.specialties.1.title': 'Tecnologia e Digital',
    'home.specialties.1.desc': 'Desenvolvimento de software, infraestrutura e produtos digitais.',
    'home.specialties.1.tags': 'TI, Desenvolvimento, Digital',
    'home.specialties.2.title': 'Dados e Analytics',
    'home.specialties.2.desc': 'Inteligência de dados, análise estratégica e BI.',
    'home.specialties.2.tags': 'Dados, BI, Analytics',
    'home.specialties.3.title': 'Operações e Infraestrutura',
    'home.specialties.3.desc': 'Processos operacionais, logística e infraestrutura corporativa.',
    'home.specialties.3.tags': 'Operações, Infraestrutura, Logística',
    'home.specialties.4.title': 'Produto e Experiência',
    'home.specialties.4.desc': 'Gestão de produto, UX/UI e experiência do cliente.',
    'home.specialties.4.tags': 'Produto, UX, Experiência',
    'home.specialties.5.title': 'Comercial e Vendas',
    'home.specialties.5.desc': 'Times de vendas, relacionamento e desenvolvimento de negócios.',
    'home.specialties.5.tags': 'Vendas, Comercial, CRM',
    'home.specialties.6.title': 'Segurança e Conformidade',
    'home.specialties.6.desc': 'Governança, compliance e segurança corporativa.',
    'home.specialties.6.tags': 'Segurança, Compliance, Riscos',
