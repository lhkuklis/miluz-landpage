...
const WhatsAppButton = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open('https://wa.me/5511969114510', '_blank');
  };
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex flex-col items-end space-y-3">
      ...
      <button
        ...
        className="group relative bg-[#25D366] hover:bg-[#20BC5A] text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-1000 animate-float border-[1.33px] border-[#39175d]"
